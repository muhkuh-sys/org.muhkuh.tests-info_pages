...
local atArtifacts =
{
...

  {
    ...
    strModule = 'info_pages',
    strArtifact = 'info_pages',
...
--        },
        ...
        'installer/org.muhkuh.tests-info_pages/install.lua',
        'installer/org.muhkuh.tests-info_pages/install_testcase.lua'
      },
      extensions = {'tar', 'xz'},
      format = 'tar',
      filter = {'xz'}
    ...
    templates = {
      artifact_configuration = 'installer/org.muhkuh.tests-info_pages/info_pages.xml',
      pom = 'installer/org.muhkuh.tests-info_pages/pom.xml'
    },
